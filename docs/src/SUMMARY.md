...
- [Identity model](architecture/identity.md)
- [Data and backups](architecture/data.md)
...
- [Provisioning a machine](operations/provisioning.md)
- [CI](operations/ci.md)
- [Pages](operations/pages.md)
- [Runbook](operations/runbook.md)
- [Failure modes and recovery](operations/recovery.md)
- [Development](operations/development.md)

# History

- [Migration off Ubuntu](history/migration.md)
- [Postmortems](history/postmortems/index.md)
